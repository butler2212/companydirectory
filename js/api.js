...
function myFunction() {
    if (window.pageYOffset > sticky) {
      header.classList.add("sticky", "row");
    } else {
      header.classList.remove("sticky", "row");
    }
  }
        ...
        success: function(result) {
           //console.log(result);   //Bug Testing
            ...
            if(result['message'] == 'error') {
                //this is a fail safe, but its primarily in place to reset page when users deselect option from title dropdown menus
